...
// コンストラクタ
CommandMoveForward::CommandMoveForward()
{

}
// 初期化する
void CommandMoveForward::Initialize()
{
}

// 実行する
void CommandMoveForward::Execute(const DX::StepTimer& timer, DirectX::Keyboard* keyboard, Tank* tank)
{
	// スピードを設定する Set speed
...
// 後始末をする
void CommandMoveForward::Finalize()
{
